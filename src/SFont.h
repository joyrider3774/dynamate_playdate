...
// sets the playdate api instance so sfont can use it
// pd_api: the playdate api instance
...
//		 The Surface must be transparant between letters in the image (not pink)
SFont_Font* SFont_InitFont (LCDBitmap *Font);
...
void SFont_Write(LCDBitmap *Surface, const SFont_Font *Font, int x, int y,
				 const char *text);
...
void SFont_WriteCenter(LCDBitmap *Surface, const SFont_Font* Font, int y,
					   const char *text);
